    ...
    return (
        <View>
            <Pressable style={{ backgroundColor: "#f8f8f8", borderRadius: 8, padding: 10, flexDirection: "row", alignItems: "center", justifyContent: "space-between", margin: 14 }}>
                ...
                <View>
                    <Text style={{ width: 83, fontSize: 17, fontWeight: "700", marginBottom: 5 }}>{item.name}</Text>
                ...
                <Text style={{ borderColor: "gray", borderWidth: 0.8, marginVertical: 10, color: "#088F8F", textAlign: "center", padding: 5, borderRadius: 3.5, fontSize: 17, fontWeight: "bold" }}>Add</Text>
            </Pressable>
                )}
                {/* // <Pressable onPress={addItemToCart} style={{ width: 80, }}>
                //     <Text style={{ borderColor: "gray", borderWidth: 0.8, marginVertical: 10, color: "#088F8F", textAlign: "center", padding: 5, borderRadius: 3.5, fontSize: 17, fontWeight: "bold" }}>Add</Text>
